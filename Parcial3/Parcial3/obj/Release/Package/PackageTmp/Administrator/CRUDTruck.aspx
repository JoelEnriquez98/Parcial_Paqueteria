<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/Administrator.Master" AutoEventWireup="true" CodeBehind="CRUDTruck.aspx.cs" Inherits="Parcial3.Administrator.CRUDTruck" %>
            ...
            <div class="col-lg-4 col-md-9">
                <div class="w-100 d-flex flex-column align-items-center justify-content-around">
                    <div class="text-align-center mb-4">
                        <h6 class="display-6">Registrar/Edit Camiones</h6>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-outline form-floating">
                                <asp:DropDownList ID="DropDownModel" CssClass="form-control" runat="server" placeholder=""></asp:DropDownList>
                                <asp:Label ID="LabelDropDownModel" AssociatedControlID="DropDownModel" CssClass="form-label" runat="server" Text="Modelo"></asp:Label>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-outline form-floating">
                                <asp:DropDownList ID="DropDownType" CssClass="form-control" runat="server" placeholder="" OnSelectedIndexChanged="DropDownType_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-outline form-floating">
                                <asp:DropDownList ID="DropDownBranch" CssClass="form-control" runat="server" AutoPostBack="true" placeholder="" OnSelectedIndexChanged="DropDownBranch_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-outline form-floating">
                                <asp:DropDownList ID="DropDownListLine" CssClass="form-control" runat="server" placeholder=""></asp:DropDownList>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-outline form-floating">
                                <asp:DropDownList ID="DropDownState" CssClass="form-control " runat="server" placeholder=""></asp:DropDownList>
